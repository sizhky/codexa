...
router.post('/register', authLimiter, async (req, res) => {
  try {
    ...
    const invitationSupplied = invitationToken !== undefined && invitationToken !== null && invitationToken !== '';
    const invitation = invitationSupplied && findActiveInvitation(db, invitationToken, cleanEmail);
    if ((invitationRequired || invitationSupplied) && !invitation) {
